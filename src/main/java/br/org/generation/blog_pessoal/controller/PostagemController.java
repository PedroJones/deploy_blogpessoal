...
import br.org.generation.blog_pessoal.repository.PostagemRepository;
...
public class PostagemController {
	...
	@Autowired 
	private PostagemRepository postagemRepository; //inejeção de dependência.
	@Autowired
	private TemaRepository temaRepository;
	@GetMapping
	public ResponseEntity<List<Postagem>> getAll (){ //ResposeEntity - atualiza um status
	...
	public ResponseEntity<Postagem> getById(@PathVariable Long id) {
		return postagemRepository.findById(id).map
	...
	/*Se hoje chover, então eu vou ficar casa.
	 * -> 
	 * P - Hoje choveu
	 * Q - eu vou ficar em casa
	 * 
	 */
